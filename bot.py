...
async def get_name(msg: Message,state:FSMContext):
    ...
    await msg.answer("Fadlan soo dir sawirkaaga:")
...
async def get_photo(msg: Message,state:FSMContext):
    ...
    await msg.answer("Fadlan gali da'daada:")
...
async def get_age(msg: Message,state:FSMContext):
    ...
    kb=InlineKeyboardMarkup([[InlineKeyboardButton("CONFIRM",callback_data=f"confirm_user_{msg.from_user.id}"),InlineKeyboardButton("REJECT",callback_data=f"reject_user_{msg.from_user.id}")]])
